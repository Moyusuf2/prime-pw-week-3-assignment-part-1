...
let favoriteFoods = ['alfredo chicken', 'pizza', 'chicken quesadilla']
...
favoriteFoods.push('chocolate cake')
...
favoriteFoods.unshift('chips');
console.log('Added new food at the beginning', favoriteFoods);
